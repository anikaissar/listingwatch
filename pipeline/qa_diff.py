...
OUT_COLS = [
    "nh_sku", "fsn", "pdp_availability", "flipkart_page_broken", "no_d2c_match",
...
def run(flipkart_path, d2c_path, out_path, do_visual=False):
    ...
    for i, fk in enumerate(flipkart_rows, 1):
        ...
        if not d2c:
            ...
            out_rows.append({
                ...
                "flipkart_page_broken": "", "no_d2c_match": True,
                "flipkart_title": fk.get("obs_title", ""), "d2c_title": "",
                "title_seq_ratio": "", "title_d2c_term_coverage": "", "title_plausible": "",
                "desc_seq_ratio": "", "desc_token_jaccard": "",
                "ingredients_coverage": "",
                "shelf_life_status": "no_d2c_match", "d2c_shelf_life": "", "flipkart_max_shelf_life": "",
                "flipkart_extraction_source": fk.get("extraction_source", ""),
                "flipkart_image_count": fk.get("obs_image_count", ""), "d2c_image_count": "",
        ...
        out_rows.append({
            "nh_sku": nh_sku, "fsn": fk.get("fsn", ""),
            "pdp_availability": fk.get("pdp_availability", ""),
            "flipkart_page_broken": broken, "no_d2c_match": False,
    ...
    if unmatched:
        ...
        print(f"NO_D2C_MATCH: {len(unmatched)} Flipkart rows ({len(uniq)} distinct nh_sku) had no D2C match "
    ...
    comparable = [r for r in out_rows if not r["flipkart_page_broken"] and not r["no_d2c_match"]]
